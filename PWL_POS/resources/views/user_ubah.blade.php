...
<html>
    ...
    <body>
        ...
        <a href="/Pemrograman_Web_Lanjut/PWL_POS/public/user">Kembali</a>
        <br><br>

        <form method="post" action="/Pemrograman_Web_Lanjut/PWL_POS/public/user/ubah_simpan/{{ $data->user_id }}">
